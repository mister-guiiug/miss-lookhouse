...
// Source : src/domain/similarity.ts · Régénérer : npm run build:edge-core
...
import { textSimilarity } from './text.ts';
import { geoSimilarity } from './geo.ts';
import { imageSimilarity } from './imageHash.ts';
